...
export class LocationsController {
  ...
  getProvinces(@Query() query: RwandaLocationQueryDto) {
  ...
  getDistricts(@Query() query: RwandaLocationQueryDto) {
  ...
  getSectors(@Query() query: RwandaLocationQueryDto) {
  ...
  getVillages(@Query() query: RwandaLocationQueryDto) {
  ...
  getCells(@Query() query: RwandaLocationQueryDto) {
